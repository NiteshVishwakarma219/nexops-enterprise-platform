...
-- CreateEnum
CREATE TYPE "AssetCategory" AS ENUM ('laptop', 'desktop', 'monitor', 'mobile', 'accessory', 'software_license', 'other');

-- CreateEnum
CREATE TYPE "AssetStatus" AS ENUM ('available', 'assigned', 'under_repair', 'retired');

-- CreateEnum
CREATE TYPE "AttendanceStatus" AS ENUM ('present', 'absent', 'half_day', 'late', 'work_from_home');
...
-- CreateEnum
CREATE TYPE "TicketCategory" AS ENUM ('it', 'hr', 'facilities', 'finance', 'other');
...
-- AddForeignKey
ALTER TABLE "Ticket" ADD CONSTRAINT "Ticket_raisedById_fkey" FOREIGN KEY ("raisedById") REFERENCES "Employee"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
